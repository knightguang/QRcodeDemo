...
//  Copyright © 2016年 guang. All rights reserved.
//
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    ...
    if (metadataObjects != nil && [metadataObjects count] > 0) {
        ...
        if ([[metadataObj type] isEqualToString:AVMetadataObjectTypeQRCode] && [metadataObj isKindOfClass:[AVMetadataMachineReadableCodeObject class]]) {
            ...
            webvc.urlString = [result stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]];
            [self.navigationController pushViewController:webvc animated:YES];

            return;
        }
        else if ([[metadataObj type] isEqualToString:AVMetadataObjectTypeEAN13Code] && [metadataObj isKindOfClass:[AVMetadataMachineReadableCodeObject class]]) {
